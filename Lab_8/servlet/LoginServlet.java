...
public class LoginServlet extends WebChatServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		pw.println(
				"<html><head><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'><title>Мега-чат!</title></head>");
		...
		// Вывести форму
		pw.println(
				"<form action='/Lab8/' method='post'>Введите имя: <input type='text' name='name' value=''><input type='submit' value='Войти в чат'>");
